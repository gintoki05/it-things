  ...
  if (activeItems.length === 0) {
    return (
      <button
        ...
        className="flex items-center gap-1.5 h-7 px-2 bg-[#1A1600] hover:bg-[#2A2400] text-[#FFD700] font-mono text-[11px] border-2 border-t-[#FFE600] border-l-[#FFE600] border-r-[#8A7500] border-b-[#8A7500] rounded-[2px] shadow-[0_0_6px_rgba(255,215,0,0.25)] cursor-pointer transition-all active:translate-y-px shrink-0 select-none"
      >
